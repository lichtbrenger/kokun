...
var app = (function () {
    ...
    /* src/TaskList.svelte generated by Svelte v3.49.0 */
    ...
    function create_each_block(ctx) {
    	let li;
    	let button;
    	let t0_value = /*task*/ ctx[1].japanese + "";
    	let t0;
    	let t1;
    	let t2_value = /*task*/ ctx[1].dutch + "";
    	let t2;
    	let t3;
    	let mounted;
    	let dispose;
    	...
    	function click_handler() {
    		return /*click_handler*/ ctx[0](/*task*/ ctx[1]);
    	}
    ...
    function create_fragment$1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (tasks.length === 0) return create_if_block;
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ title, TaskList });
